...
@Entity
@Table(name="games_performed")  // gametoplayid ile hangi maç oldupu alınacak, 1. ve 2. takım skorları ve diğer olaylar(kim attı vs)
@Data
public class GamePerformed extends BaseEntity {
    ...
    private GameToPlay gameToPlay; // aşamayı tutacak. enum'da yapabilirsin. ayrı tabloda da tutabilirsin.
}
